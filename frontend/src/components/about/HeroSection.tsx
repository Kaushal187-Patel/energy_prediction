...
const HeroSection = () => {
  return (
    <div className="text-center mb-16">
      <div className="inline-flex items-center px-4 py-2 rounded-full bg-blue-500/20 dark:bg-blue-500/20 text-blue-600 dark:text-blue-400 text-sm font-medium mb-6">
