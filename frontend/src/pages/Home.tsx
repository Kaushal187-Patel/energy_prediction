      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="text-center">
            <div className="inline-flex items-center px-4 py-2 rounded-full bg-green-500/20 dark:bg-green-500/20 text-green-600 dark:text-green-400 text-sm font-medium mb-8 animate-float-up">
            ...
            <h1 className="text-5xl md:text-7xl font-bold mb-6 animate-float-up">
              ...
              <br />
              <span className="text-gray-900 dark:text-white">Consumption</span>
            </h1>

            <p className="text-xl text-gray-700 dark:text-gray-300 max-w-3xl mx-auto mb-12 animate-float-up">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              <Card
                key={index}
                className="bg-white/80 dark:bg-white/5 border-gray-200 dark:border-white/10 hover:bg-white dark:hover:bg-white/10 transition-all duration-300 group"
              >
