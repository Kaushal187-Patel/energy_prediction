...
const Team = () => {
  ...
  const teamMembers: TeamMember[] = [
    ...
    },
    {
      ...
      experience: [
        {
          company: "Adani Green Energy Ltd. - Adani Shantigram, Ahmedabad",
          position: "Intern",
          duration: "08 May, 2025 - 07 June, 2025",
          description: "Worked on Project 'Digital Twins for Wind Asset Management.' Performed data cleaning and analysis on renewable energy datasets. Gained hands-on exposure to real-time industrial operations in green energy."
        }
      ],
      projects: [
        {
      ...
      skills: {
        languages: "Python, C, C++, NumPy, Pandas, Matplotlib, Seaborn",
        web: "HTML, CSS, JavaScript, SQL",
        tools: "Git, GitHub, VSCode, Jupyter Notebook, TensorFlow, Scikit-learn, Streamlit"
      }
    },
    {
      name: "Kaneriya Hasti", 
      ...
      projects: [
        {
          name: "Operations Analytics and Investigating Metric Spike",
          description: "This project focuses on Operational Analytics to identify and improve inefficiencies across operations. Learned how to investigate sudden spikes or drops in key metrics by analyzing trends over time.",
          tech: "SQL, Data Analytics"
        },
        {
          name: "Instagram User Analytics",
          description: "This project focuses on analyzing Instagram user interaction data to find engagement pattern and user behavior. Gained deeper understanding of user engagement pattern on Instagram.",
          tech: "MySQL Workbench 8.0, SQL"
        },
        {
          name: "Yoga Guru",
          description: "Real-time yoga pose classifier using webcam with ML model for pose identification and visual feedback.",
      ...
      skills: {
        ...
        tools: "Git, GitHub, VSCode , MySQL Workbench, Jupyter Notebook"
      }
    },
    {
      name: "Kadiya Bansi",
      ...
      projects: [
        {
          name: "AI for Early Disease Prediction",
          description: "Developed a machine learning-based web application to predict chronic diseases such as diabetes, heart disease, and Parkinson's from user-inputted medical data. The system offers early disease risk assessment via an intuitive interface and supports healthcare professionals with data-driven insights.",
          tech: "Python, Streamlit, Scikit-learn, TensorFlow, MongoDB"
        },
        {
          name: "Yoga Guru",
          description: "Real-time yoga pose classifier using webcam with ML model for pose identification and visual feedback.",
      ...
      skills: {
        languages: "C, C++, Python, MySQL, Streamlit, Scikit-learn, TensorFlow",
        web: "HTML, CSS, JavaScript, MongoDB",
        tools: "Git, GitHub, VSCode , Jupyter Notebook, Streamlit"
      }
    }
  ];
